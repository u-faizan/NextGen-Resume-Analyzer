...
st.sidebar.markdown(
    """
    <style>
    /* Heading box styling: darker teal background */
    .sidebar-heading {
        background-color: #117864; /* Darker shade of teal */
        color: white;
        padding: 5px 10px;
        border-radius: 4px;
        font-size: 1.2em;
        font-weight: bold;
        margin: 10px 0 0 0; /* No extra left margin */
        width: 100%;
    }
    ...
    .sidebar-body {
        ...
        padding: 5px 10px;
        border-radius: 4px;
        margin: 0 0 10px 0; /* 10px margin at bottom; flush on left */
        text-align: left;
    }
    </style>
